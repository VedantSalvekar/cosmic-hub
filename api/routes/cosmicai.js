    ...
    try{
        ...
        if(!question || question.trim().length === 0){
            return res.status(400).json({
                ...
                message: 'Please provide a question to ask the Cosmic AI Assistant'
            });
        }
        ...
        if (!openai) {
            return res.status(503).json({
                ...
                message: 'The Cosmic AI Assistant is currently unavailable. OpenAI API key not configured.',
                data: {
                    question: question,
                    response: '🚀 Stellar question! Unfortunately, the Cosmic AI Assistant is currently offline for maintenance. But I can tell you that the universe is full of amazing mysteries waiting to be discovered! Try exploring our APOD section or asteroid tracker while the AI assistant is being upgraded! 🌌',
